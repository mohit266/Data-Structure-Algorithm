...
public class MaximumBuildingHeight {
    public static void main(String[] args) {
       int n = 10;
       int[][] restrictions = {{2,4},{3,2},{4,0},{5,3},{6,2},{7,3},{8,5},{9,0},{10,0}};

       MaximumBuildingHeight m = new MaximumBuildingHeight();

        System.out.println(m.maxBuilding(n, restrictions));

    }

    public int maxBuilding(int n, int[][] restrictions) {
        List<int[]> restrictionList = new ArrayList<>(Arrays.asList(restrictions));
        restrictionList.add(new int[] {1, 0});

        restrictionList.sort((a, b) -> a[0] - b[0]);
