...
// TODO : This a DP problem. Will check later.
public class FindNumberOfSubsequencesWithEqualGCD {

    public static void main(String[] args) {
        FindNumberOfSubsequencesWithEqualGCD f = new FindNumberOfSubsequencesWithEqualGCD();

        int[] nums = {1, 2, 3, 4};

        System.out.println(f.subsequencePairCount(nums));
